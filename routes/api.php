...
// Virtual Account Lock Management (New Granular System)
...
// URL: https://[domain]/api/webhook/paymentpoint
Route::post('/webhook/paymentpoint', [App\Http\Controllers\API\PaymentPointWebhookController::class, 'handleWebhook']);
